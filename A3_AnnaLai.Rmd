...
![Caption: GSEA Enrichment results](.\a3_analysis.GseaPreranked.1712263512608\global_es_histogram.png) 
```{r gsea_pos}
...
- **Total Heap size** was 104M, it took around 10 minutes to build the network diagram. 

![Caption: Paremeters used.](./A3figs/network.png) 
