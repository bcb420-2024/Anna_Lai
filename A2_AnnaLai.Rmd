...
```{r MDS_condition fig.height = 15, fig.width = 15}
colors_plot<- sample(colors()[1:657], 10)

limma::plotMDS(d, labels=NULL,pch=1, cex=0.8,
...
```{r MDS_bio_rep fig.height = 15, fig.width = 15}
colors_plot<- sample(colors()[1:657], 3)
...
```{r MDS_cell_line fig.height = 15, fig.width = 15}
colors_plot<- sample(colors()[1:657], 3)
