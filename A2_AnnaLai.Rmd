...
![GO result.](./A3figs/Full_2.png) 318 total gene sets returned. The top term is Cell Cycle, Mitotic. 

![Caption: Enrichment results](./A3figs/Full_3.png) 
![Caption: Enrichment results continue](./A3figs/Full_4.png) 

![Caption: Paremeters used.](./A3figs/Full_1.png) 
### Up-Regualted Genes

 ![Caption: GO result.](./A3figs/UpReg_1.png) 
![Caption: Up regulated genes are mostly involved with cat ion binding.](./A3figs/UpReg_2.png) 
![Caption: Paremeters used.](./A3figs/UpReg_3.png) 
  
### Down-Regualted Genes

There are way more down-regulated genes than up regulated genes.

![Caption: Go result.](./A3figs/DownReg_3.png) 
![Caption: Enrichment results](./A3figs/DownReg_1.png) 
...
![Caption: Paremeters used.](./A3figs/DownReg_2.png) 
